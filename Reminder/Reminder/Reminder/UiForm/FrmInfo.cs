...
namespace PopupForm
{
    public partial class FrmInfo : Form
    {
        ...
        public void ShowForm()
        {
            switch (this.FormNowState)
            {
                case FormState.Hide:
                    ...
                    AnimateWindow(this.label1.Handle, 800, AW_SLIDE + AW_VER_NEGATIVE);
                    AnimateWindow(this.button1.Handle, 800, AW_SLIDE + AW_VER_NEGATIVE);
                    break;
            }
        }
        #endregion
        ...
        {
            System.Diagnostics.Process.Start("chrome.exe", "http://172.17.208.141:8084/");//chrome.exe iexplore.exes
        }
    }
    /**
     * 【AnimateWindow说明】
