...
{
    public partial class FormEventSection : Form
    {
        public EventSection ParentNode { get; set; }

        public EventSection CurrentNodeInfo { get; set; }

        public FormEventSection(EventSection parent, EventSection info = null)
        {
        ...
        private void FormEventSection_Load(object sender, EventArgs e)
        {
        ...
        private void Ok_Click(object sender, EventArgs e)
        {
            ...
            if (this.CurrentNodeInfo == null)
            {
                this.CurrentNodeInfo = new EventSection()
                {
